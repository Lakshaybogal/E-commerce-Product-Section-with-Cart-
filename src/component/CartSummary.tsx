...
const Cart: React.FC<CartProps> = ({ cart, setCart, closeCart, setTotalQuantityInCart, totalQuantityInCart }) => {
    ...
    return (
        <div className='bg-white drop-shadow-xl rounded-md z-10 fixed top-[45vh] w-[90%] md:w-96 px-10 pb-10 pt-2 primary-color '>
            <p className="px-3 py-1 absolute right-0 top-1" onClick={closeCart}>Close</p>
            <div className="pt-6 px-6 w-[100%]">
